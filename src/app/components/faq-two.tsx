    ...
    <div className="container relative">
      <div className="grid md:grid-cols-2 grid-cols-1 items-center gap-[30px]">
        <div className="relative order-1 md:order-2">
            ...
            <ReactWOW animation="fadeInUp">
              ...
              >
                <Link
                  ...
                  className="lightbox size-20 rounded-full shadow-md dark:shadow-gyay-700 inline-flex items-center justify-center text-white bg-myjamiiGreen"
                >
          ...
          <div className="overflow-hidden absolute md:size-[500px] size-[400px] bg-gradient-to-tr to-myjamiiGreen/20 via-myjamiiGreen/70 from-myjamiiGreen bottom-1/2 translate-y-1/2 md:end-0 end-1/2 md:translate-x-0 translate-x-1/2 -z-1 shadow-md shadow-myjamiiGreen/10 rounded-full"></div>
          ...
          >
            <div className="flex items-center">
              <div className="flex items-center justify-center size-[65px] bg-myjamiiGreen/5 text-myjamiiGreen text-center rounded-full me-3">
          ...
          <ReactWOW animation="fadeInUp">
            ...
            >
              ...
              <h4 className="mb-6 md:text-3xl text-2xl md:leading-normal leading-normal font-bold">
                Safe. Secure. Engaging. Respectful
              </h4>
              <p className="text-slate-400 max-w-xl mx-auto">
                MyJamii is built on the foundations of friendly, supportive, and
                  ...
                  <h2 className="font-semibold">
                    <button
                      ...
                      className={`flex justify-between items-center p-5 w-full font-medium text-start ${
                        activeTab === item.id
                          ? 'bg-slate-50/50 dark:bg-slate-800/20 text-myjamiiGreen'
                          : ''
                      }`}
                    >
