          ...
          <ReactWOW animation="fadeInUp" delay="0.1s">
            ...
            >
              ...
              <p className="text-slate-500 text-lg max-w-xl mx-auto">
                Meet with people from your home countries and other countries
                who are living near you. Be part of a vibrant community.
              </p>
                  ...
                  return (
                    <ReactWOW animation="fadeInUp" key={index}>
                      <div
                        ...
                        data-wow-delay=".3s"
                      >
                        <div className="flex md:order-2 order-1 align-middle justify-center items-center size-16 mt-1 bg-myjamiiGreen/5 dark:bg-myjamiiGreen/10 group-hover:bg-myjamiiGreen group-hover:text-white text-myjamiiGreen rounded-2xl text-2xl shadow-sm dark:shadow-gray-800 duration-500">
                  ...
                  return (
                    <ReactWOW animation="fadeInUp" key={index}>
                      <div
                        ...
                        data-wow-delay=".9s"
                      >
                        <div className="flex align-middle justify-center items-center size-16 mt-1 bg-myjamiiGreen/5 dark:bg-myjamiiGreen/10 group-hover:bg-myjamiiGreen group-hover:text-white text-myjamiiGreen rounded-2xl text-2xl shadow-sm dark:shadow-gray-800 duration-500">
                          <Icon className="size-5" />
                        </div>
